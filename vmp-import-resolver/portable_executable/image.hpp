...
namespace portable_executable
{
	...
	public:
		...
		section_header_t* get_sections();

		[[nodiscard]] const section_header_t* get_sections() const;

		section_header_t* get_section(std::size_t index);

		[[nodiscard]] const section_header_t* get_section(std::size_t index) const;
